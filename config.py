...
GENERAL_SCHEMA = vol.Schema({
    ...
    vol.Optional(CONF_PUBLISH_INTERVAL): cv.time_interval,
})
...
class Config:
    ...
    def _parse_general(self, doc) -> None:
        ...
        if CONF_GENERAL in doc:
            ...
            if CONF_PUBLISH_INTERVAL in doc[CONF_GENERAL]:
                self.htknx.publish_interval = doc[CONF_GENERAL][CONF_PUBLISH_INTERVAL]
