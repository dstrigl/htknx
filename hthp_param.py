...
class HtHeatpumpParam(Device):
    ...
    async def process_group_read(self, telegram):
        ...
        self.xknx.logger.info(
            "HtHeatpumpParam.process_group_read: %s", telegram
        )
    ...
    async def process_group_write(self, telegram):
        ...
        self.xknx.logger.info(
            "HtHeatpumpParam.process_group_write: %s", telegram
        )
    ...
    def __str__(self):
        ...
        return '<HtHeatpumpParam name="{}" ' 'group_address="{}" value="{}" unit="{}" writable="{}"/>'.format(
            self.name,
